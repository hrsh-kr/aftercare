...
| 0:55–1:05 | Click **Live demo**, then click an order file ("Start with an order file") to show the check | "This is the demo. Everything on it was recorded while I ran the tool: the agent's actual replies, the tickets, the dashboard. Nothing is hard-coded." |
